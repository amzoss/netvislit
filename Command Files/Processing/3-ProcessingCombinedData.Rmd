...
graded_num_ans <- dplyr::mutate(joined_num_ans, 
                                ...
                                LogError = log10(abs(Response - CorrectAnswer) + 1))
...
graded_nodes_top <- dplyr::mutate(graded_nodes_best_of_25_buffer, 
                                ...
                                LogError = log10(abs(NodeValue - MaxValue) + 1))
...
# should I omit anyone from ResearchMatch? the student or faculty pools?
...
graded_num_ans <- graded_num_ans %>% filter(!(`Demo-ResponseID` %in% red_flag_users$`Demo-ResponseID`))

graded_nodes_top <- graded_nodes_top %>% filter(!(`Demo-ResponseID` %in% red_flag_users$`Demo-ResponseID`))
...
num_ans_lim <- graded_num_ans %>% filter(QType == "Exp") %>% select(`Demo-ResponseID`, Condition, Dataset, Task, Response, DatasetOrder, DatasetDuration, DatasetStartTime, TaskOrder, CorrectAnswer, RawDifference, AbsDifference, Percentage, LogError, ClustConf, filename, `Stats-Q_TotalDuration`, `Stats-dataset_count`, `Stats-CompensationCondition`, `Stats-OperatingSystem`, `Stats-ScreenResolution`, `Demo-age`, `Demo-gender`, `Demo-lang`, `Demo-educ`, `Demo-educ_TEXT`, `Demo-acfield`, `Demo-acfieldother`, `Demo-dailytech_Computer`, `Demo-dailytech_Tablet`, `Demo-dailytech_SmartPhone`, `Demo-weeklygaming`, `Demo-expdataanal`, `Demo-expdatavis`, `Demo-expreadnetvis`, `Demo-expcreatenetvis`, NetVisExperience)

nodes_lim <- graded_nodes_top %>% filter(QType == "Exp") %>% select(`Demo-ResponseID`, Condition, Dataset, Task, Attempt, NodeValue, DatasetOrder, DatasetDuration, DatasetStartTime, TaskOrder, MaxValue, RawDifference, AbsDifference, Percentage, LogError, filename, `Stats-Q_TotalDuration`, `Stats-dataset_count`, `Stats-CompensationCondition`, `Stats-OperatingSystem`, `Stats-ScreenResolution`, `Demo-age`, `Demo-gender`, `Demo-lang`, `Demo-educ`, `Demo-educ_TEXT`, `Demo-acfield`, `Demo-acfieldother`, `Demo-dailytech_Computer`, `Demo-dailytech_Tablet`, `Demo-dailytech_SmartPhone`, `Demo-weeklygaming`, `Demo-expdataanal`, `Demo-expdatavis`, `Demo-expreadnetvis`, `Demo-expcreatenetvis`, NetVisExperience)
...
#write_csv(exp_only, file.path("~/Desktop","ExperimentalResponsesOnly.csv"))

#write_csv(all_exp, file.path("~/Desktop","AllExperimental.csv"))
