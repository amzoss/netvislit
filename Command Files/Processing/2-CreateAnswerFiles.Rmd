...
# When creating node_lookup, don't just calculate node rank. Also calculate percentage error between node value and max value, like with normal numerical answers; e.g., (MaxValue - NodeValue)/MaxValue

node_degree_lookup <- node_degree_lookup %>%
  mutate(Percentage = abs(MaxValue - NodeValue)/MaxValue)
